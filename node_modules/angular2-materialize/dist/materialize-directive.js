...
var MaterializeDirective = (function () {
    ...
    MaterializeDirective.prototype.performElementUpdates = function () {
        ...
        if (this.isDatePicker()) {
            ...
            jQueryElement_1.on("change", function (e) { return nativeElement_3.dispatchEvent(((CustomEvent("input")))); });
        ...
        if (this.isTimePicker()) {
            ...
            jQueryElement.on("change", function (e) { return nativeElement_4.dispatchEvent(((CustomEvent("input")))); });
        }
        if (this.isChips()) {
